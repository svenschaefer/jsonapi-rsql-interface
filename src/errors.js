...
const ERROR_CATALOG = Object.freeze({
  ...
  wildcard_not_allowed: { status: 400, title: "Wildcard not allowed" },
  wildcard_operator_not_allowed: { status: 400, title: "Wildcard operator not allowed" },
  wildcard_type_not_supported: { status: 400, title: "Wildcard type not supported" },
  invalid_wildcard_pattern: { status: 400, title: "Invalid wildcard pattern" },
